...
public class dboFuncionario implements Cloneable
{
private int codigo;
private String nome;
private String cpf;
...
public dboFuncionario (int cod, String nome,String cpf,String email,float salario,String telefone,String cargo,String conta,String agencia,String endereco,String usuario,String senha) throws Exception
    {
...
dboFuncionario fun = (dboFuncionario)obj;
...
public Object clone()
{
dboFuncionario ret = null;
try
{
ret = new dboFuncionario (this);
}
...
public dboFuncionario(dboFuncionario molde) throws Exception
{
if(molde == null)
throw new Exception();
