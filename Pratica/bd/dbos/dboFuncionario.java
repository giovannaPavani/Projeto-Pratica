...
public class Funcionario implemfuns Cloneable
{
private int cod;
private String nome;
private String cpf;
...
if(fun.cod != this.cod || fun.nome != this.nome || fun.cargo != this.cargo || fun.email != this.email || fun.cpf != this.cpf || fun.telefone != this.telefone || fun.conta != this.conta || fun.agencia != this.agencia || fun.endereco != this.endereco || fun.usuario != this.usuario || fun.senha != this.senha || fun.salario != this.salario)
return false;
