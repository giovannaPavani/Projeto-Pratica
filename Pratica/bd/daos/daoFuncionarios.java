...
public class Funcionarios
{
    ...
    public static void alterar (Funcionario funcionario) throws Exception
    {
        ...
        if (!cadastrado (funcionario.getCod()))
            throw new Exception ("Nao cadastrado");
        ...
        try
        {
            ...
            BDSQLServer.COMANDO.setInt    (12, funcionario.getCod ());
    ...
    public static Funcionario getFuncionario (int codigo) throws Exception
    {
        ...
        try
        {
            ...
            funcionario = new Funcionarios(resultado.getInt   ("CODIGO"),
        ...
        public static int getCodigo (String usuario) throws Exception
        {
            try
            {
                ...
                BDSQLServer.COMANDO.setSring (1, usuario);
        ...
        return (int)resultado.rows[0].cells[0];
    }
