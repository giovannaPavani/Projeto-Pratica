...
public class Produtos
{
    ...
    public static void incluir (Produto produto) throws Exception
    {
        ...
        try //aqui tem um try catch, pq se der merda no meio do try, ele para e da rollback(pq ele quer TUDO ou NADA)
        {
            ...
            BDSQLServer.COMANDO.setInt    (1, livro.getCodigo ());  //troca as interrogacoes por valores
            BDSQLServer.COMANDO.setString (2, livro.getNome ());
            BDSQLServer.COMANDO.setFloat  (3, livro.getPreco ());
            BDSQLServer.COMANDO.setString (4, livro.getTipo ());
    ...
    public static void alterar (Produto produto) throws Exception
    {
        ...
        try
        {
            ...
            BDSQLServer.COMANDO.setString (3, livro.getTipo ());
            BDSQLServer.COMANDO.setInt    (4, livro.getCodigo ());
