...
public class daoEntidades
{
    ...
    public static void incluir(dboEntidade entidade) throws Exception
    {
        if (entidade==null)
    ...
    public static void alterar(dboEntidade entidade) throws Exception
    {
        if (entidade==null)
    ...
    public static dboEntidade getEntidade(int codigo) throws Exception
    {
        dboEntidade entidade = null;
        ...
        try
        {
            ...
            entidade = new dboEntidade(resultado.getInt  ("CODIGO"),
