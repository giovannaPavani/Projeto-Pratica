...
public class daoFuncionarios
{
    ...
    public static void incluir (dboFuncionario funcionario) throws Exception
    {
        if (funcionario==null)
    ...
    public static void alterar (dboFuncionario funcionario) throws Exception
    {
        if (funcionario==null)
            throw new Exception ("Funcionario nao fornecido");
    ...
    public static dboFuncionario getFuncionario (int codigo) throws Exception
    {
        dboFuncionario funcionario = null;
        ...
        try
        {
            ...
            funcionario = new dboFuncionario(resultado.getInt("CODIGO"),
