...
public class dboDoacao implements Cloneable, Comparable<dboDoacao>
{
    private int codigo;
 ...
 public Date getData() 
 {
	...
	public dboDoacao (int cod, int codEnt, int codPes, Date dat)throws Exception
	{
		this.setCodigo      (cod);
	...
	public dboDoacao(dboDoacao modelo)throws Exception
	{
	  if(modelo == null)
	    throw new Exception();
	...
	public Object clone()
	{
	  ...
	  try
	  {
	    ret = new dboDoacao(this);
	  }
	  catch(Exception erro){}
	  return ret;
	}
	
	public int compareTo(dboDoacao outro)
	{
