...
public class dboEntidade implements Cloneable, Comparable<dboEntidade>
{
	 private int codigo;
	 private String nome;
	 ...
	 public dboEntidade(int codigo, String nome, String email, String cnpj, String conta, String agencia, String endereco, String usuario, String senha, String telefone, int visualizacoes) throws Exception
	 {
	...
	public boolean Equals(Object obj)
	{
		...
		dboEntidade ent = (dboEntidade)obj;
	
		if(ent.codigo != this.codigo || ent.nome != this.nome || ent.email != this.email || ent.cnpj != this.cnpj || ent.telefone != this.telefone || ent.conta != this.conta || ent.agencia != this.agencia || ent.endereco != this.endereco || ent.usuario != this.usuario || ent.senha != this.senha || ent.visualizacoes != this.visualizacoes)
			return false;
	...
	public Object clone()
	{
		dboEntidade ret = null;
		try
		{
			ret = new dboEntidade (this);
		}
	...
	public dboEntidade(dboEntidade molde) throws Exception
	{
		if(molde == null)
			throw new Exception();
	...
	public int compareTo(dboEntidade outro)
	{
