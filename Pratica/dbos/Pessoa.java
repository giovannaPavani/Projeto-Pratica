...
public class bdoPessoa implements Cloneable, Comparable<bdoPessoa>
{
	 private int codigo;
	 private String nome;
	 ...
	 public bdoPessoa (int codigo, String nome, String email, String cpf, String conta, String agencia, String endereco, String usuario, String senha, String telefone) throws Exception
	 {
	...
	public bdoPessoa(bdoPessoa modelo) throws Exception
	{
		if(modelo == null)
			throw new Exception();
	...
	public int compareTo(bdoPessoa outro)
	{
